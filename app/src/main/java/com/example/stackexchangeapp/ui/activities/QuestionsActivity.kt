...
class QuestionsActivity: BaseActivity(), QuestionsRecyclerView.OnQuestionClickedListener {
    ...
    private val questionsRecyclerView by lazy { compositionRoot.viewFactory().getQuestionsRecyclerView(null) }
    ...
    private fun fetchQuestions() = compositionRoot.getStackExchangeApi()
        .fetchLastActiveQuestions(QUESTIONS_LIST_PAGE_SIZE)
